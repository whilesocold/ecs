...
(function (FamilyEvent) {
    FamilyEvent["ENTITY_ADDED"] = "FamilyEvent.ENTITY_ADDED";
    FamilyEvent["ENTITY_REMOVED"] = "FamilyEvent.ENTITY_REMOVED";
...
var CachedFamily = (function (_super) {
    ...
    function CachedFamily(engine, include, exclude) {
        ...
        _this.onEntityChanged = function (entity) {
            ...
            if (index === -1) {
                ...
                _this.emit(FamilyEvent.ENTITY_ADDED, entity);
            }
    ...
    CachedFamily.prototype.onEntityRemoved = function (entity) {
        ...
        if (index !== -1) {
            ...
            this.emit(FamilyEvent.ENTITY_REMOVED, entity_1);
        }
    };
    return CachedFamily;
}(AbstractFamily));
